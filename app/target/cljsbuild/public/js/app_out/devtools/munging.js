...
var o22727 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22727["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22728 = temp__5455__auto____$1;
...
var o__22312__auto__ = f;
return (o__22312__auto__["toString"]).call(o__22312__auto__);
} else {
return "";
}
...
try{var o__22312__auto___22731 = t;
(o__22312__auto___22731["cljs$lang$ctorPrWriter"]).call(o__22312__auto___22731,t,writer);
...
var char_code = (function (){var o__22312__auto__ = (new String(char$));
return (o__22312__auto__["charCodeAt"]).call(o__22312__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22312__auto__ = String;
return (o__22312__auto__["fromCharCode"]).call(o__22312__auto__,subscript_code);
});
/**
...
var o__22312__auto__ = String;
return (o__22312__auto__["fromCharCode"]).call(o__22312__auto__,superscript_code);
});
/**
...
}catch (e22756){var _e__22339__auto__ = e22756;
return false;
}})())){
...
var vec__22761 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22761,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o22787 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22787["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22788 = temp__5455__auto____$1;
return (o22788["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22800){
var vec__22801 = p__22800;
var ns_detector = cljs.core.nth.call(null,vec__22801,(0),null);
...
var G__22817 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22818 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22817;
remaining_tokens = G__22818;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22794){
var G__22795 = cljs.core.first.call(null,seq22794);
var seq22794__$1 = cljs.core.next.call(null,seq22794);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22795,seq22794__$1);
});
...
var vec__22832 = cljs.core.split_with.call(null,(function (p1__22829_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22829_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22832,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22832,(1),null);
...
var vec__22846 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22846,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22846,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22855 = cljs.core.rest.call(null,remaining_tokens);
var G__22856 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22855;
name_tokens = G__22856;
continue;
} else {
...
var vec__22865 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22865,(0),null);
var arity = cljs.core.nth.call(null,vec__22865,(1),null);
var vec__22868 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22868,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22868,(1),null);
var vec__22871 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22871,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22871,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22871,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22871,(3),null);
...
var vec__22895 = result;
var munged_ns = cljs.core.nth.call(null,vec__22895,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22895,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22895,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22895,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22895,(4),null);
var arity = cljs.core.nth.call(null,vec__22895,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__22906 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__22906,(0),null);
var args = cljs.core.nth.call(null,vec__22906,(1),null);
var vec__22911 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22911,(0),null);
var name = cljs.core.nth.call(null,vec__22911,(1),null);
...
var G__22952 = (arity + (1));
var G__22953 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22958){
var vec__22959 = p__22958;
var arity = cljs.core.nth.call(null,vec__22959,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22959,(1),null);
...
return cljs.core.get.call(null,arities,p1__22991_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22992_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23014){
var vec__23015 = p__23014;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23015,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23007){
var G__23008 = cljs.core.first.call(null,seq23007);
var seq23007__$1 = cljs.core.next.call(null,seq23007);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23008,seq23007__$1);
});
...
var map__23070 = options;
var map__23070__$1 = ((((!((map__23070 == null)))?(((((map__23070.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23070.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23070):map__23070);
var include_ns_QMARK_ = cljs.core.get.call(null,map__23070__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23070__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23070__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23070__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23076 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23076,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23076,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23076,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23076,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23076,(4),null);
var arity = cljs.core.nth.call(null,vec__23076,(5),null);
...
var o__22312__auto__ = f;
return (o__22312__auto__["getBasis"]).call(o__22312__auto__);
});
/**
...
}catch (e23100){var _e__22339__auto__ = e23100;
...
var G__23108 = (obj[cljs.core.first.call(null,path)]);
var G__23109 = cljs.core.rest.call(null,path);
obj = G__23108;
path = G__23109;
continue;
} else {
...
return (function (accum,p__23137){
var vec__23138 = p__23137;
var bit = cljs.core.nth.call(null,vec__23138,(0),null);
var protocol = cljs.core.nth.call(null,vec__23138,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23150){
var vec__23151 = p__23150;
var ns = cljs.core.nth.call(null,vec__23151,(0),null);
var name = cljs.core.nth.call(null,vec__23151,(1),null);
var selector = cljs.core.nth.call(null,vec__23151,(2),null);
...
return (function (p__23163){
var vec__23164 = p__23163;
var munged_name = cljs.core.nth.call(null,vec__23164,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23164,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23164,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23159_SHARP_){
return (obj[cljs.core.first.call(null,p1__23159_SHARP_)]);
});})(name,sorted_matches,vec__23164,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1539633376342

...
}catch (e25697){var _e = e25697;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___25702 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___25702)){
var seen_errors_25703 = temp__5455__auto___25702;
if(cljs.core.truth_(seen_errors_25703.has(self))){
} else {
seen_errors_25703.add(self);

var temp__5457__auto___25704 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___25704)){
var sense_25705 = temp__5457__auto___25704;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_25705)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1539633379466

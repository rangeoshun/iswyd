...
var i__4532__auto___23424 = (0);
while(true){
if((i__4532__auto___23424 < len__4531__auto___23420)){
args__4534__auto__.push((arguments[i__4532__auto___23424]));

var G__23426 = (i__4532__auto___23424 + (1));
i__4532__auto___23424 = G__23426;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23417){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23418,G__23419,seq23417__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23437_SHARP_){
return !((cljs.core.meta.call(null,p1__23437_SHARP_) == null));
})))){
...
var map__23442 = opts;
var map__23442__$1 = ((((!((map__23442 == null)))?(((((map__23442.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23442.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23442):map__23442);
var markup_db = cljs.core.get.call(null,map__23442__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23446){var _e__22339__auto__ = e23446;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e23448){var _e__22339__auto__ = e23448;
return false;
}}
})())){
...
var _STAR_current_state_STAR_23451 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__23453 = opts;
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_23451;
}});
...
;
var temp__5455__auto___23457 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___23457)){
var managed_print_level_23458 = temp__5455__auto___23457;
var _STAR_print_level_STAR_23456_23459 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_23458;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_23456_23459,managed_print_level_23458,temp__5455__auto___23457,writer,opts,job_fn){
return (function (p1__23455_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__23455_SHARP_,null);
});})(_STAR_print_level_STAR_23456_23459,managed_print_level_23458,temp__5455__auto___23457,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_23456_23459;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1539633376691

...
return (new CustomEvent(event_name,(function (){var obj28975 = {"detail":data};
return obj28975;
})()));
} else {
...
var f = (function (){var pred__29006 = cljs.core._EQ_;
var expr__29007 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29006.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29007))){
return ((function (pred__29006,expr__29007){
return (function (p1__28980_SHARP_){
return console.warn(p1__28980_SHARP_);
});
;})(pred__29006,expr__29007))
} else {
if(cljs.core.truth_(pred__29006.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29007))){
return ((function (pred__29006,expr__29007){
return (function (p1__28981_SHARP_){
return console.debug(p1__28981_SHARP_);
});
;})(pred__29006,expr__29007))
} else {
if(cljs.core.truth_(pred__29006.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29007))){
return ((function (pred__29006,expr__29007){
return (function (p1__28982_SHARP_){
return console.error(p1__28982_SHARP_);
});
;})(pred__29006,expr__29007))
} else {
return ((function (pred__29006,expr__29007){
return (function (p1__28983_SHARP_){
return console.log(p1__28983_SHARP_);
});
;})(pred__29006,expr__29007))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29069){
...
var eval_fn = cljs.core.get.call(null,map__29070__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__29085_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__29102,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1539633381407

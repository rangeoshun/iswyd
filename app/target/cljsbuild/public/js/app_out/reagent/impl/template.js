...
var G__25337 = o;
(G__25337[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__25346__i < G__25346__a.length) {G__25346__a[G__25346__i] = arguments[G__25346__i + 0]; ++G__25346__i;}
  args = new cljs.core.IndexedSeq(G__25346__a,0,null);
} 
...
var G__25350 = o;
(G__25350[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__25359__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__25360__i < G__25360__a.length) {G__25360__a[G__25360__i] = arguments[G__25360__i + 0]; ++G__25360__i;}
  args = new cljs.core.IndexedSeq(G__25360__a,0,null);
} 
return G__25359__delegate.call(this,args);};
G__25359.cljs$lang$maxFixedArity = 0;
G__25359.cljs$lang$applyTo = (function (arglist__25361){
var args = cljs.core.seq(arglist__25361);
return G__25359__delegate(args);
});
...
var G__25363 = props;
var G__25363__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__25363,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__25363);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__25363__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__25364){
...
var props = map__25365__$1;
var class$ = cljs.core.get.call(null,map__25365__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__25365,map__25365__$1,props,class$){
return (function (c){
...
});})(map__25365,map__25365__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__25367){
...
var on_write = cljs.core.get.call(null,map__25368__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__25368,map__25368__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__25368,map__25368__$1,on_write))
);
} else {
...
var G__25371 = jsprops;
(G__25371["defaultValue"] = value);

(G__25371["onChange"] = ((function (G__25371,v,value,on_change){
return (function (p1__25370_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__25370_SHARP_);
});})(G__25371,v,value,on_change))
);
...
var vec__25374 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25374,(0),null);
var id = cljs.core.nth.call(null,vec__25374,(1),null);
var class$ = cljs.core.nth.call(null,vec__25374,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___25378 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___25378 == null)){
} else {
var key_25379 = temp__5461__auto___25378;
(jsprops["key"] = key_25379);
}
...
var temp__5461__auto___25380 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___25380 == null)){
} else {
var key_25381 = temp__5461__auto___25380;
reagent.impl.template.oset.call(null,jsprops,"key",key_25381);
}
...
var G__25382 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__25382["name"] = c);
...
var len__4531__auto___25387 = arguments.length;
var i__4532__auto___25388 = (0);
while(true){
if((i__4532__auto___25388 < len__4531__auto___25387)){
args__4534__auto__.push((arguments[i__4532__auto___25388]));

var G__25389 = (i__4532__auto___25388 + (1));
i__4532__auto___25388 = G__25389;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq25385){
var G__25386 = cljs.core.first.call(null,seq25385);
var seq25385__$1 = cljs.core.next.call(null,seq25385);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25386,seq25385__$1);
});
...
break;
default:
var G__25392 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__25392;
continue;
...
var n__4408__auto___25394 = a.length;
var i_25395 = (0);
while(true){
if((i_25395 < n__4408__auto___25394)){
(a[i_25395] = reagent.impl.template.as_element.call(null,(a[i_25395])));
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___25397 = a.length;
var i_25398 = (0);
while(true){
if((i_25398 < n__4408__auto___25397)){
var val_25399 = (a[i_25398]);
if(((cljs.core.vector_QMARK_.call(null,val_25399)) && ((reagent.impl.template.key_from_vec.call(null,val_25399) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_25398] = reagent.impl.template.as_element.call(null,val_25399));
...
var ctx = ({});
var vec__25401 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__25401,(0),null);
var derefed = cljs.core.nth.call(null,vec__25401,(1),null);
...
var G__25404 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25404) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__25404){
...
//# sourceMappingURL=template.js.map?rel=1539633379182

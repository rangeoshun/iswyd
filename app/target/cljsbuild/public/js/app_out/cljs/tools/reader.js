...
var G__27312 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__27312;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__27313 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__27313,ch);
...
if(("\\" === ch__$1)){
var ch_27314__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_27314__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_27314__$2);
} else {
}
...
var vec__27333 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27333,(0),null);
var start_column = cljs.core.nth.call(null,vec__27333,(1),null);
...
var G__27344 = cljs.core.conj_BANG_.call(null,a,form);
a = G__27344;
continue;
}
}
...
var _STAR_read_delim_STAR_27347 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_27347;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__27365 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27365,(0),null);
var start_column = cljs.core.nth.call(null,vec__27365,(1),null);
...
var vec__27368 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27368,(0),null);
var end_column = cljs.core.nth.call(null,vec__27368,(1),null);
...
var vec__27394 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27394,(0),null);
var start_column = cljs.core.nth.call(null,vec__27394,(1),null);
...
var vec__27397 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27397,(0),null);
var end_column = cljs.core.nth.call(null,vec__27397,(1),null);
...
var vec__27414 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27414,(0),null);
var start_column = cljs.core.nth.call(null,vec__27414,(1),null);
...
var vec__27417 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27417,(0),null);
var end_column = cljs.core.nth.call(null,vec__27417,(1),null);
...
var sb = (function (){var G__27421 = (new goog.string.StringBuffer());
G__27421.append(initch);
...
var G__27424 = (function (){var G__27422 = sb;
G__27422.append(ch);

return G__27422;
})();
var G__27425 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__27424;
ch = G__27425;
continue;
}
...
switch (G__27431) {
case "\\":
var G__27437 = (function (){var G__27432 = sb;
G__27432.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__27432;
})();
var G__27438 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__27437;
ch = G__27438;
continue;
...
break;
default:
var G__27439 = (function (){var G__27433 = sb;
G__27433.append(ch);

return G__27433;
})();
var G__27440 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__27439;
ch = G__27440;
continue;
...
var vec__27442 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27442,(0),null);
var end_column = cljs.core.nth.call(null,vec__27442,(1),null);
...
var vec__27447 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27447,(0),null);
var column = cljs.core.nth.call(null,vec__27447,(1),null);
...
var vec__27464 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27464,(0),null);
var column = cljs.core.nth.call(null,vec__27464,(1),null);
...
var vec__27469 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27469,(0),null);
var column = cljs.core.nth.call(null,vec__27469,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__27479 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27479,(0),null);
var start_column = cljs.core.nth.call(null,vec__27479,(1),null);
...
var vec__27482 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27482,(0),null);
var end_column = cljs.core.nth.call(null,vec__27482,(1),null);
...
var G__27485 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__27485,true,null,opts,pending_forms);
...
var G__27487 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__27487)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__27487)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__27487)){
...
var _STAR_suppress_read_STAR_27498 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_27498;
}});
...
var G__27499 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__27499,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__27499,rdr,first_line);
...
var G__27523 = matched;
var G__27524 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__27523;
finished = G__27524;
continue;
} else {
...
var _STAR_suppress_read_STAR_27530 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_27530;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env27550 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__27551 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__27551,"(");
...
var G__27556 = (i + (1));
var G__27557 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3949__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env27550;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__27571 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__27571);
...
var G__27608 = cljs.core.next.call(null,s__$1);
var G__27609 = ret;
s__$1 = G__27608;
r = G__27609;
continue;
...
var G__27618 = cljs.core.next.call(null,s);
var G__27619 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__27618;
key_vals = G__27619;
continue;
} else {
...
var gensym_env27755 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env27755;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__27762 = token;
var G__27762__$1 = (((G__27762 == null))?null:cljs.core.subs.call(null,G__27762,(1)));
var G__27762__$2 = (((G__27762__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27762__$1));
var G__27762__$3 = (((G__27762__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27762__$2));
var G__27762__$4 = (((G__27762__$3 == null))?null:cljs.core.symbol.call(null,G__27762__$3));
if((G__27762__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__27762__$4);
}
})():(function (){var G__27764 = token;
var G__27764__$1 = (((G__27764 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27764));
if((G__27764__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27764__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__27814,reader){
...
var eof = cljs.core.get.call(null,map__27815__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4531__auto___27835 = arguments.length;
var i__4532__auto___27836 = (0);
while(true){
if((i__4532__auto___27836 < len__4531__auto___27835)){
args__4534__auto__.push((arguments[i__4532__auto___27836]));

var G__27837 = (i__4532__auto___27836 + (1));
i__4532__auto___27836 = G__27837;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq27832){
var G__27833 = cljs.core.first.call(null,seq27832);
var seq27832__$1 = cljs.core.next.call(null,seq27832);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27833,seq27832__$1);
});


//# sourceMappingURL=reader.js.map?rel=1539633380776
